...
HD_PWD='/home/danilo-alencar/Documents/GitHub/Aging-V2/Aging_V2/Aging_V2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log croc_xilinx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source croc_xilinx.tcl -notrace
