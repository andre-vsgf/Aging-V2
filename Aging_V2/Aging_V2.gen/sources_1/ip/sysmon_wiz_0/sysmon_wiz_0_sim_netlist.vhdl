...
-- Date        : Wed Jan 14 13:50:32 2026
-- Host        : daniloalencar.lesc.ufc.br running 64-bit Linux Mint 22.1
-- Command     : write_vhdl -force -mode funcsim -rename_top sysmon_wiz_0 -prefix
--               sysmon_wiz_0_ sysmon_wiz_0_sim_netlist.vhdl
-- Design      : sysmon_wiz_0
...
entity sysmon_wiz_0_sysmon_wiz_0_sysmon is
  port (
...
end sysmon_wiz_0_sysmon_wiz_0_sysmon;

architecture STRUCTURE of sysmon_wiz_0_sysmon_wiz_0_sysmon is
...
entity sysmon_wiz_0 is
  ...
  attribute NotValidForBitStream of sysmon_wiz_0 : entity is true;
end sysmon_wiz_0;

architecture STRUCTURE of sysmon_wiz_0 is
begin
inst: entity work.sysmon_wiz_0_sysmon_wiz_0_sysmon
     port map (
      alarm_out => alarm_out,
      busy_out => busy_out,
