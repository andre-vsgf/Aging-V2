...
-- Date        : Wed Jan 14 13:40:28 2026
-- Host        : daniloalencar.lesc.ufc.br running 64-bit Linux Mint 22.1
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sysmon_wiz_0_sim_netlist.vhdl
-- Design      : sysmon_wiz_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysmon_wiz_0_sysmon is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysmon_wiz_0_sysmon;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysmon_wiz_0_sysmon is
...
inst_sysmon: unisim.vcomponents.SYSMONE4
    generic map(
      ...
      ALM(7) => alarm_out,
      ALM(6 downto 3) => NLW_inst_sysmon_ALM_UNCONNECTED(6 downto 3),
      ALM(2) => vccaux_alarm_out,
      ALM(1 downto 0) => NLW_inst_sysmon_ALM_UNCONNECTED(1 downto 0),
      BUSY => busy_out,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysmon_wiz_0_sysmon
     port map (
      alarm_out => alarm_out,
      busy_out => busy_out,
