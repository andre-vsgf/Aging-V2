...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clk_wiz_clk_wiz is
  signal catcher_clk_i_clk_wiz : STD_LOGIC;
  signal clk_in1_clk_wiz : STD_LOGIC;
  signal psclk_rf_i_clk_wiz : STD_LOGIC;
  signal reset_high : STD_LOGIC;
  signal soc_clk_clk_wiz : STD_LOGIC;
...
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0_PHASE => 20.000000,
      CLKOUT0_USE_FINE_PS => "FALSE",
      CLKOUT1_DIVIDE => 63,
      CLKOUT1_DUTY_CYCLE => 0.500000,
      CLKOUT1_PHASE => -330.000000,
