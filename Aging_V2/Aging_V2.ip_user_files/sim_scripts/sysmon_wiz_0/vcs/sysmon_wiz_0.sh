...
#
# Script generated by Vivado on Wed Jan 14 14:38:27 -03 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sysmon_wiz_0.sh
...
#
# Usage        : sysmon_wiz_0.sh
#                sysmon_wiz_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sysmon_wiz_0.sh [-reset_run]
#                sysmon_wiz_0.sh [-reset_log]
#                sysmon_wiz_0.sh [-help]
#
...
#                script (type 'sysmon_wiz_0.sh -help' for more information).
#
...
# script info
echo -e "sysmon_wiz_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sysmon_wiz_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+TARGET_FPGA= +define+TARGET_AUP15= +define+TARGET_XILINX= +define+WITH_SYSTEM_MONITOR= +define+WITH_TELEMETRY_TX= +define+WITH_SENSOR= +define+WITH_SENSOR_LF= +define+WITH_SENSOR_AM= +define+COMMON_CELLS_ASSERTS_OFF= +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+TARGET_FPGA= +define+TARGET_AUP15= +define+TARGET_XILINX= +define+WITH_SYSTEM_MONITOR= +define+WITH_TELEMETRY_TX= +define+WITH_SENSOR= +define+WITH_SENSOR_LF= +define+WITH_SENSOR_AM= +define+COMMON_CELLS_ASSERTS_OFF= +incdir+"../../../../../../../../AMD/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sysmon_wiz_0 xil_defaultlib.glbl -o sysmon_wiz_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sysmon_wiz_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sysmon_wiz_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sysmon_wiz_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sysmon_wiz_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sysmon_wiz_0.sh [-help]\n\
Usage: sysmon_wiz_0.sh [-step]\n\
Usage: sysmon_wiz_0.sh [-lib_map_path]\n\
Usage: sysmon_wiz_0.sh [-reset_run]\n\
Usage: sysmon_wiz_0.sh [-reset_log]\n\
Usage: sysmon_wiz_0.sh [-keep_index]\n\
Usage: sysmon_wiz_0.sh [-noclean_files]\n\n\
