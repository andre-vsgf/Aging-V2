...
export RDI_DATADIR="/home/danilo-alencar/AMD/2025.1/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8 -d "TARGET_FPGA" -d "TARGET_AUP15" -d "TARGET_XILINX" -d "WITH_SYSTEM_MONITOR" -d "WITH_TELEMETRY_TX" -d "WITH_SENSOR" -d "WITH_SENSOR_LF" -d "WITH_SENSOR_AM" -d "COMMON_CELLS_ASSERTS_OFF"  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sysmon_wiz_0 xil_defaultlib.sysmon_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sysmon_wiz_0 -key {Behavioral:sim_1:Functional:sysmon_wiz_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/danilo-alencar/AMD/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sysmon_wiz_0.wdb xsim.dir libdpi.so)
