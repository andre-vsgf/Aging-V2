...
`ifdef WITH_SENSOR_DM
  ...
  output logic [31:0] alarm_dm_high_o,
  output logic [31:0] alarm_dm_low_o,
`else
`endif
...
`endif
  ...
  `ifdef WITH_SENSOR_DM
    ...
    .catcher_clk_i        (catcher_clk_i),
    .alarm_dm_low_o       (alarm_dm_low_o),
    .alarm_dm_high_o      (alarm_dm_high_o),
  `else
 `endif
    .clk_i,
    .rst_ni,
  ...
  logic [(cf_math_pkg::idx_width(NumXbarSbr)*NumXbarManagers)-1:0] alarm_i_main_xbar;
  ...
  obi_xbar #(
    ...
    .rst_ni,
    `ifdef WITH_SENSOR_OBI_DMX
      .psclk_dmx_i   ( psclk_obi_dmx_i ),
      .catcher_clk_i ( catcher_clk_i   ),
      .alarm_dmx_o   ( alarm_i_main_xbar ),
    `else
    `endif
    .testmode_i,
  ...
  logic [cf_math_pkg::idx_width(NumPeriphs)-1:0] alarm_i_obi_demux;

  assign alarm_obi_dmx_o = {alarm_i_obi_demux, alarm_i_main_xbar};
